...
class ActivityPredictor:
    ...
    def __init__(self, model_type: Literal["svr", "rf", "adaboost", "lightgbm", "xgboost", "xgboost_rf"], x_arr, y_arr,
                 split=(80, 10, 10), seed=random.seed):
    ...
    def train(self, k_folds: Optional[int] = 0):
        ...
        if self._model_type in ["svr", "rf", "adaboost", "lightgbm", "xgboost", "xgboost_rf"]:
    ...
    def save_model(self, filename):
        ...
        if self._is_trained is False:
            ...
            if self._model_type in ["svr", "rf", "adaboost", "gboost"]:
                import pickle
                if not ensemble:
